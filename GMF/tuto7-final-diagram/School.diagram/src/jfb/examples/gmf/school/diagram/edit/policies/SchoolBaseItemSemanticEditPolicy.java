 ...
 * @generated
 */
public class SchoolBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected SchoolBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		request.setParameter(SchoolBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(SchoolBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(SchoolBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = SchoolElementTypes
	...
	public static class LinkConstraints {
		...
		public static boolean canCreateStudentFriends_4001(Student source,
			...
			return canExistStudentFriends_4001(source, target);
		}
