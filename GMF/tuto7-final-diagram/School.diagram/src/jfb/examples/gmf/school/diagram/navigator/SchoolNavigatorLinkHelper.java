 ...
 * @generated
 */
public class SchoolNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = SchoolDiagramEditorPlugin.getInstance()
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		SchoolAbstractNavigatorItem abstractNavigatorItem = (SchoolAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof SchoolNavigatorItem) {
			navigatorView = ((SchoolNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof SchoolNavigatorItem) {
				navigatorView = ((SchoolNavigatorItem) navigatorGroup
						.getParent()).getView();
			}
		}
