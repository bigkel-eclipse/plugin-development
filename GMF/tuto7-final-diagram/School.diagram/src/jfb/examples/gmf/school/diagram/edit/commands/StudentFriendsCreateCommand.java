 ...
 * @generated
 */
public class StudentFriendsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StudentFriendsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Student) {
			return false;
		}
		if (target != null && false == target instanceof Student) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getFriends().add(getTarget());
		}
