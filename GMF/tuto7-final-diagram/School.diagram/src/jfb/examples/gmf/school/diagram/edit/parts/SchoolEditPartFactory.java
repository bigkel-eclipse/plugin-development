 ...
 * @generated
 */
public class SchoolEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case SchoolEditPart.VISUAL_ID:
				return new SchoolEditPart(view);

			case SchoolNameEditPart.VISUAL_ID:
				return new SchoolNameEditPart(view);

			case ClassroomEditPart.VISUAL_ID:
				return new ClassroomEditPart(view);

			case ClassroomNameEditPart.VISUAL_ID:
				return new ClassroomNameEditPart(view);
			...
			case SchoolSchoolClassroomsCompartmentEditPart.VISUAL_ID:
				return new SchoolSchoolClassroomsCompartmentEditPart(view);

			case ClassroomClassroomStudentsCompartmentEditPart.VISUAL_ID:
				return new ClassroomClassroomStudentsCompartmentEditPart(view);

			case StudentFriendsEditPart.VISUAL_ID:
				return new StudentFriendsEditPart(view);
