...
import jfb.examples.gmf.school.diagram.part.SchoolDiagramEditor;
 ...
 * @generated
 */
public class SchoolNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof SchoolNavigatorItem) {
					selectedElement = ((SchoolNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, SchoolDiagramEditor.ID);
