...
public class DiagramImpl extends EObjectImpl implements Diagram {
	...
	public void setSchool(School newSchool) {
		if (newSchool != school) {
			...
			if (school != null)
				msgs = ((InternalEObject)school).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchoolPackage.DIAGRAM__SCHOOL, null, msgs);
			if (newSchool != null)
				msgs = ((InternalEObject)newSchool).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchoolPackage.DIAGRAM__SCHOOL, null, msgs);
			msgs = basicSetSchool(newSchool, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchoolPackage.DIAGRAM__SCHOOL, newSchool, newSchool));
	}
