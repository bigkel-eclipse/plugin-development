 ...
 * @generated
 */
public class NodeModelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NodeModelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MyParserProvider.getParser(MyElementTypes.NodeModel_2001, getParserElement(),
					MyVisualIDRegistry.getType(bigkel.diagram.edit.parts.NodeModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
