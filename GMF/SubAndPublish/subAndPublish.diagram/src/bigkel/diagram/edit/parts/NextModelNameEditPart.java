 ...
 * @generated
 */
public class NextModelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NextModelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MyParserProvider.getParser(MyElementTypes.NextModel_2002, getParserElement(),
					MyVisualIDRegistry.getType(bigkel.diagram.edit.parts.NextModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
