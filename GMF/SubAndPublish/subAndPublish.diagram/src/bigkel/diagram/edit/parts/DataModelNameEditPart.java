...
import bigkel.diagram.edit.policies.MyTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DataModelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataModelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new MyTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return MyElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MyParserProvider.getParser(MyElementTypes.DataModel_3001, getParserElement(),
					MyVisualIDRegistry.getType(bigkel.diagram.edit.parts.DataModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, MyEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
