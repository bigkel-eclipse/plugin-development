 ...
 * @generated
 */
public class BigkelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BigkelPackage.ROOT: {
				Root root = (Root)theEObject;
				T result = caseRoot(root);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BigkelPackage.NODE_MODEL: {
				NodeModel nodeModel = (NodeModel)theEObject;
				T result = caseNodeModel(nodeModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BigkelPackage.DATA_MODEL: {
				DataModel dataModel = (DataModel)theEObject;
				T result = caseDataModel(dataModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BigkelPackage.NEXT_MODEL: {
				NextModel nextModel = (NextModel)theEObject;
				T result = caseNextModel(nextModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Next Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Next Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNextModel(NextModel object) {
		return null;
	}
