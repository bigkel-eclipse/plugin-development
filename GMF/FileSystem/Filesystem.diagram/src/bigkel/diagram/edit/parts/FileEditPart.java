...
import bigkel.diagram.edit.policies.FileItemSemanticEditPolicy;
...
public class FileEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FileNameEditPart) {
			((FileNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureFileNameFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(MyVisualIDRegistry.getType(FileNameEditPart.VISUAL_ID));
	}
