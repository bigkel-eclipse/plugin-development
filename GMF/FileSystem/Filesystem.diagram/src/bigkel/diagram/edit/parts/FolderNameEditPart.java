 ...
 * @generated
 */
public class FolderNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MyParserProvider.getParser(MyElementTypes.Folder_2001, getParserElement(),
					MyVisualIDRegistry.getType(bigkel.diagram.edit.parts.FolderNameEditPart.VISUAL_ID));
		}
		return parser;
	}
