 ...
 * @generated
 */
public class FileNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = MyParserProvider.getParser(MyElementTypes.File_2002, getParserElement(),
					MyVisualIDRegistry.getType(bigkel.diagram.edit.parts.FileNameEditPart.VISUAL_ID));
		}
		return parser;
	}
