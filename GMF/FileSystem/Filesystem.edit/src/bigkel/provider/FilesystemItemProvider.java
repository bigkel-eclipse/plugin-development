...
/**
 * This is the item provider adapter for a {@link bigkel.Filesystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FilesystemItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BigkelPackage.Literals.FILESYSTEM__FOLDERS);
			childrenFeatures.add(BigkelPackage.Literals.FILESYSTEM__FILES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BigkelPackage.Literals.FILESYSTEM__FOLDERS,
				 BigkelFactory.eINSTANCE.createFolder()));

		newChildDescriptors.add
			(createChildParameter
				(BigkelPackage.Literals.FILESYSTEM__FILES,
				 BigkelFactory.eINSTANCE.createFile()));
	}
